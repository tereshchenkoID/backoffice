...
const build = gulp => gulp.series('copy:json', 'copy:img', 'copy:fonts', 'copy:data');
// eslint-disable-next-line no-shadow
const watch = gulp => () => gulp.watch(`${config.src.data  }/**/*`, gulp.parallel('copy:json', 'copy:img', 'copy:fonts', 'copy:data'));
